 ...
 * Usage: npx tsx scripts/run-fixtures.ts
 */
import { readFileSync, readdirSync } from "node:fs";
import { createHmac } from "node:crypto";
import { join } from "node:path";
import { mapTallyPayload, validateMapped, type TallyWebhookPayload } from "../src/map";
import { recomputeScore } from "../src/score";
import { verifyTallySignature } from "../src/verify";
import { resolveIdempotencyKey } from "../src/idempotency";
